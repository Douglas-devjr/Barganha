...
export const funcoes = [
  ...
  },
  {
    ...
    area: 'app',
    status: 'parcial',
    oque: 'Avisa quando um produto que você acompanha cai de preço na sua região.',
    falta:
      'Não existe notificação PUSH — o aviso só aparece quando o app é aberto e o sync roda. Um alerta que dispara com o app fechado é o comportamento que o usuário espera de "alerta", e hoje ele não acontece.',
    ligacoes: ['notificacoes', 'sincronizador', 'editar-produto'],
    arquivos: [
